...
class Window(QtGui.QWidget):
    ...
    def initUI(self):
        ...
        self.txtSaveFilePathName.setText(
            'Y:\\Kat Han\\CC Cabinet\Data\\CCData_' + self.txtUserName.text())
    ...
    def btnReconnectClicked(self):
        ...
        name = self.txtSaveFilePathName
        self.txtSaveFilePathName.setText(name + self.txtUserName.text())
    ...
    def btnStartClicked(self):
        ...
        self.WriteToFile("Cycle Number, Epoch Time (seconds), Time (hrs),Current Status," + \
                         ...
                         "Temp 13, Temp 14, Temp 15, Temp 16\n", self.txtSaveFilePathName.text(),
                         self.first_time_seconds)
    ...
    def btnStopClicked(self):
        ...
        def btnStartClicked(self):
            ...
            if (VERBOSE == 1): print "intBiasCurrentState ="
            if (VERBOSE == 1): print str(self.intBiasCurrentState)
            self.serArduino.write(str(int(self.intBiasCurrentState)) + ',' + str(
                int(self.txtCurrentOnTempSetpoint.text())) + ',' + str(
                int(self.txtCurrentOffTempSetpoint.text())) + ',' + str(
                int(self.txtOvertempSetpoint.text())) + ',' + '\r\n')
            time.sleep(0.02)
            if (VERBOSE == 1): print "wrote to arduino"
    ...
    def SendPowerPowerSupplyCommand(self):
        ...
        if self.intBiasOnTimerSeconds % SAVETIME == 0 and self.intBiasOffTimerSeconds % SAVETIME == 0:
            self.WriteToFile(str(self.cycle_number) + "," + str(time_now) + "," + str(hrs_now) + "," + str(
                self.intBiasCurrentState) + "," + \
                             str(TDK_DATA[0, 2]) + "," + str(TDK_DATA[0, 0]) + "," + str(TDK_DATA[1, 2]) + "," + str(
                TDK_DATA[1, 0]) + "," + str(TDK_DATA[2, 2]) + "," + str(TDK_DATA[2, 0]) + "," + \
                             str(TDK_DATA[3, 2]) + "," + str(TDK_DATA[3, 0]) + "," + str(TDK_DATA[4, 2]) + "," + str(
                TDK_DATA[4, 0]) + "," + str(TDK_DATA[5, 2]) + "," + str(TDK_DATA[5, 0]) + "," + \
                             str(TDK_DATA[6, 2]) + "," + str(TDK_DATA[6, 0]) + "," + str(TDK_DATA[7, 2]) + "," + str(
                TDK_DATA[7, 0]) + "," + str(TDK_DATA[8, 2]) + "," + str(TDK_DATA[8, 0]) + "," + \
                             str(TDK_DATA[9, 2]) + "," + str(TDK_DATA[9, 0]) + "," + str(TDK_DATA[10, 2]) + "," + str(
                TDK_DATA[10, 0]) + "," + str(TDK_DATA[11, 2]) + "," + str(TDK_DATA[11, 0]) + "," + \
                             str(self.intTempSensor1) + "," + str(self.intTempSensor2) + "," + str(
                self.intTempSensor3) + "," + str(self.intTempSensor4) + "," + \
                             str(self.intTempSensor5) + "," + str(self.intTempSensor6) + "," + str(
                self.intTempSensor7) + "," + str(self.intTempSensor8) + "," + \
                             str(self.intTempSensor9) + "," + str(self.intTempSensor10) + "," + str(
                self.intTempSensor11) + "," + str(self.intTempSensor12) + "," + \
                             str(self.intTempSensor13) + "," + str(self.intTempSensor14) + "," + str(
                self.intTempSensor15) + "," + str(self.intTempSensor16) + "," + \
    ...
    def tmrTDKOneSecond(self):
        ...
        if (TIME_NOW_SECONDS - float(self.first_time_seconds)) / 60.0 >= (int(self.cycle_number) - 1) * (
                    float(ON_TIME) + float(OFF_TIME)) + ON_TIME and (
                    TIME_NOW_SECONDS - float(self.first_time_seconds)) / 60.0 < int(self.cycle_number) * (
            ON_TIME + OFF_TIME):
            self.intBiasCurrentState = 0

        elif (TIME_NOW_SECONDS - float(self.first_time_seconds)) / 60.0 >= int(self.cycle_number) * (
                    ON_TIME + OFF_TIME):
        ...
        dict_to_GUI["MinutesIntoCycle"] = (TIME_NOW_SECONDS - float(self.first_time_seconds)) / 60.0 - float(
